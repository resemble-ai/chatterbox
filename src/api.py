...
from src.tts_webui.utils.manage_model_state import manage_model_state
from src.tts_webui.utils.split_text_functions import split_and_recombine_text
from src.tts_webui.utils.split_text_functions import split_by_lines
from src.tts_webui.utils.get_path_from_root import get_path_from_root
...
def tts(*args, **kwargs):
    ...
    return wavs[0]["audio_out"][0], full_wav
    try:
